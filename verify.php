...
$order = "OMBS" . rand(10000, 99999999);
...
if (isset($_POST['submit'])) {
    ...
    $qry = "INSERT INTO bookingtable(`movieID`, `bookingTheatre`, `bookingType`, `bookingDate`, `bookingTime`, `bookingFName`, `bookingPNumber`, `bookingEmail`)VALUES ('$movieid','$theatre','$type','$date','$time','$fname','$mobile','$email')";
            ...
            <table border="1" style="text-align: center;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo "Online Movie Booking System"; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>4</td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <button value="Book Now!" name="sub" type="submit" class="btn btn-danger">Pay Now!</button>
