    ...
    <div class="contact-us-container">
        <div class="contact-us-section contact-us-section1">
            ...
            <form action="" method="POST">
                ...
                <textarea placeholder="Enter your message !" name="feedback" rows="10" cols="50" required></textarea><br>
        ...
        <div class="contact-us-section contact-us-section2">
            <h1 style="color: #fff;">Address & Info</h1>
            <h3 style="color: #fff;">Phone Numbers</h3>
            <p style="color: #fff;"><a href="tel:01011391148">+2 010 11 39 11 48</a><br>
                <a href="tel:01011391148">+2 010 11 39 11 48</a></p>
            <h3 style="color: #fff;">Address</h3>
            <p style="color: #fff;">El Sherouk City , Suez Desert Road , Cairo 11837 - P.O. Box 43</p>
            <h3 style="color: #fff;">E-mail</h3>
            <p style="color: #fff;"><a href="mailto:cinemareservation@bue.edu.eg">cinemareservation@bue.edu.eg</a></p>
        </div>
    </div>
