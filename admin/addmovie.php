            ...
            <div class="admin-section-column">
                ...
                <div class="admin-section-panel admin-section-panel2">
                    ...
                    <form action="" method="POST">
                        ...
                        <input placeholder="Trailer Link" type="text" name="youtubelink" required>
                        <input placeholder="Description" type="text" name="moviedetails" required>
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr align="center">
                                    <td><?php echo $ID; ?></td>
                                    <td><?php echo '<img src="../'.$row['movieImg'].'" height="80" alt=" ">'; ?></td>
